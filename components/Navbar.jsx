  ...
  return (
    <>
      <div className="absolute w-full">
        <div className="flex justify-between items-center px-12 py-4 bg-transparent font-medium text-sm">
          <div>
          ...
          <div className="hidden lg:inline">
            <ul className="flex justify-center hover:cursor-pointer">
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#models">Model S</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#model3">Model 3</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#modelx">Model X</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#modely">Model Y</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#house">Powerwall</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5" href="#charger">Lataaminen</li>
            </ul>
          </div>
          <div className="lg:inline hidden ">
            <ul className="flex justify-center hover:cursor-pointer">
              <li className="py-1 px-3 hover:rounded hover:bg-black/5">Tuki</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5">Kauppa</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5">Tili</li>
              <li className="py-1 px-3 hover:rounded hover:bg-black/5">Valikko</li>
            </ul>
          </div>

          {/* IF SCREEN SIZES SMALLER THAN LARGE */}
          <div className="lg:hidden cursor-pointer">Valikko</div>
        </div>
      </div>
    </>
  );
